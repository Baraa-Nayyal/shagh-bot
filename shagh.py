...
async def promote(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    💻 أسطورة الأكواد متعددة اللغات 💻

    ومن مهام هذا المنصب النبيل:
    • كتابة كود نظيف بلغة… ولغتين… وثلاث بدون ما يضيع 😎
    • التنقل بين لغات البرمجة وكأنه عم يغيّر قنوات 📺
    • إنتاج شغل أسطوري يخلي البقز تفكر ألف مرة قبل ما تظهر 😤

    وغالباً يكون صاحب هذا المنصب
    الشخص اللي لما تسأله "أي لغة بتستخدم؟"
    يقول: "حسب المزاج اليوم" 😅

    نشكر اجتهادك المستمر،
    وشغفك بتعلّم كل جديد،
    وقدرتك على السيطرة على أكثر من لغة بنفس الوقت 👏

    ويمكنك استلام وسام "Polyglot رسمي"
    من تحت الساعة بعد آخر كومبايل ناجح ⏰

    ⚠️ ملاحظة: هذا المنصب رمزي وفكاهي
    لكن مستواك صار يخوّف المترجمات نفسها 😏
    """
