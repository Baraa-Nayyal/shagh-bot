...
async def done(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    done_replies = [
        ...
        "تم تحويل نقطة رسمية إلى رصيد الشغف الخاص بك 💳🔥",
        "الإنجاز وصل، والنقطة وصلت معه كمان 🚀✨",
        "وزارة الإنجاز وافقت على الطلب، تفضل نقطتك 🏛️😌",
        "تم إيداع +1 نقطة في بنك الشغوفين المركزي 🏦🔥",
        "يا ساتر 😳 خذ نقطة قبل ما يطالبوك بضريبة الإنجاز 😂",
        "واضح إنك مش جاي تمزح اليوم 😎🔥 +1 نقطة",
        "النظام وقف دقيقة صمت احترامًا لهذا الإنجاز 🫡✨ +1 نقطة",
        "التسويف خسر الجولة، وأنت ربحت نقطة 🥊🔥",
        "إنجاز مسجل رسميًا 📋 ونقطة مضمونة 100% 😌",
        "تم إضافة نقطة جديدة للمجموعة الاستثمارية الخاصة بك 📈🔥",
        "خبر عاجل 🚨 الشغوف أنجز وحصل على نقطة جديدة!",
        "أيوة هيك 😎🔥 نقطة بالطريق إليك بسرعة الإنترنت",
        "الإنجاز دخل النظام... والنقطة دخلت الحساب 💰✨",
        "في شخص عم يرفع مستوى المجموعة هون 👀🔥 +1 نقطة",
        "تم توثيق الإنجاز وإرسال نقطة كمكافأة أداء 🏆",
        "حاسس البوت نفسه انبسط من الإنجاز 😂🔥 +1 نقطة",
        "التقرير وصل، والمكافأة وصلت معه 😎💳",
        "كفو والله 🔥 نقطة جديدة تزين الحساب",
        "الكسل عم يقرأ رسالتك ويبكي حاليًا 😭🔥 +1 نقطة",
        "تم منحك نقطة لأنك اخترت العمل بدل الأعذار 😌✨",
        "هيك الشغل ولا بلاش 😎🔥 نقطة جديدة بالمخزون",
        "إنجازك اليوم رفع أسهمك في بورصة الشغف 📈😂",
        "تم رصد نشاط مشبوه من نوع: إنتاجية عالية 🚨🔥 +1 نقطة",
        "النظام أكد الإنجاز بعد الفحص والتحقيق 🔍😌 تفضل نقطتك",
        "واضح إنك جاي تجمع نقاط أكثر من ألعاب الفيديو 🎮🔥",
        "ألف مبروك 🎉 نقطة جديدة انضمت للعائلة",
        "إنجاز مرتب ونقطة مرتبة أكثر 😎✨",
        "يا لطيف 😳 هيك الإنجازات بدها نقطة VIP 👑🔥",
        "تم تسجيل الإنجاز بنجاح... والتصفيق تلقائي 👏😂 +1 نقطة",
        "شهادة تقدير ما عنا، بس عنا نقطة 😎🔥",
        "الإنجاز دخل الأرشيف الذهبي للمجموعة 📚✨ +1 نقطة",
        "تمت إضافة نقطة لأنك شخص محترم ومنتج اليوم 😌🔥",
        "المراقبين أكدوا الإنجاز، اصرفوا له نقطة فورًا 🫡💳",
        "واضح إنك ناوي تخلص أهداف السنة هالأسبوع 😂🔥",
        "إنجاز جديد يعني نقطة جديدة... قوانين الطبيعة 🌍😎",
        "تم شحن الحساب بنقطة إضافية ⚡🔥",
        "الإنجاز قوي لدرجة إن السيرفر ارتجف شوي 😂🚀 +1 نقطة",
        "الكسل قدم استقالته بعد هذا الإنجاز 📝😭",
        "خذ نقطة قبل ما يجي حدا يطالب فيها 😎🔥",
        "الإنجاز وصل كامل بدون أي أضرار 😌📦 +1 نقطة",
        "تم اعتماد الملف وتحويل المكافأة فورًا 💳🔥",
        "يا كبير 😎 نقطة جديدة انضمت للرصيد",
        "واضح إنك داخل مود الوحش اليوم 🐺🔥 +1 نقطة",
        "تم إضافة نقطة بسبب نشاط إنتاجي غير اعتيادي 🚨😂",
        "الإنجاز هذا يستحق صورة مع النقطة 📸🏆",
        "النظام قال: والله كفو 🔥 وأعطاك نقطة",
        "إنجازك اليوم عامل ضجة في قسم الكسل 😭🔥",
        "تم تحويل +1 نقطة مع أطيب التمنيات بمزيد من الجلد 💪😎",
