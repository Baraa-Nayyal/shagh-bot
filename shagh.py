...
async def done(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    done_replies = [
        "شغوف اليوم فاقد الشغف... خد نقطتك وامشي 😔",
        "خد نقطة... أمرنا لله 😮‍💨",
        "العمر بيخلص والنقط ما بتخلص 😶",
        "تم إضافة نقطة... ولا تسألني كيف عايش 😔",
        "نقطة جديدة، ومشكلة جديدة بالحياة 😞",
        "مبروك +1 نقطة... شو استفدنا؟ 🤷",
        "النظام تعب... بس لسا بيعطي نقاط 😪",
        "خد نقطتك قبل ما أستقيل 🤝",
        "تمت إضافة نقطة رغم الظروف الاقتصادية الصعبة 📉😔",
        "كل يوم نقطة... وكل يوم أسئلة أكثر عن معنى الحياة 😶",
        "الإنجاز جميل... أما أنا فوضعي لا يُحسد عليه 😔",
        "تم تسجيل الإنجاز... للأسف تم تسجيله فعلًا 😮‍💨",
        "نقطة إضافية، لأن هيك مكتوب علينا 😞",
        "خذ نقطة، يمكن تفرح أكثر مني 😔",
        "البوت حزين اليوم... لكن القوانين قوانين 💔",
        "تم التحويل بنجاح، أما السعادة فما وصلت 😶",
        "مبروك نقطة جديدة... وأنا مبارح كنت أحلم بالتقاعد 😔",
        "أضفنا نقطة... وحذفنا جزء من طاقتنا 😪",
        "شكرًا على الإنجاز، أعطيتني شغل زيادة 😒",
        "تمت إضافة نقطة رغم انعدام الحماس العام 😶",
        "كل الإنجازات جميلة، بس النوم أجمل 😴",
        "خذ نقطة وسامحنا على الإزعاج 😔",
        "البوت مش مقتنع بأي شيء حاليًا... إلا إنك تستحق نقطة 😮‍💨",
        "تم منحك نقطة لأن الحياة تستمر بطريقة أو بأخرى 🚶",
        "نقطة جديدة... والراتب لسا ما نزل 💸😔",
        "إنجاز ممتاز، مزاج سيء، نقطة جاهزة 😶",
        "تمت إضافة نقطة قبل ما أغير رأيي 😔",
        "خذ نقطة... الدنيا قصيرة أصلًا 🌍",
        "النقطة وصلت، أما الطموح فله فترة غايب 😞",
        "مبروك الإنجاز... بالتوفيق للجميع وخلاص 😮‍💨",
        "تم اعتماد الإنجاز تحت بند: ماشي الحال 😶",
        "نقطة جديدة... والحياة مستمرة بشكل غريب 🤷",
        "خذ نقطة، يمكن بكرا ما نكون هون 😔",
        "البوت حالياً عايش على القهوة والواجب 😪☕",
        "تمت إضافة نقطة رغم المعارضة الداخلية 😞",
        "كل ما أعطي نقطة بتذكر قديش الطريق طويل 😔",
        "إنجازك رائع... وأنا محتاج إجازة 😴",
        "خد نقطة وخفف عنا ضغط الإنجازات 😮‍💨",
        "تم تسجيل الإنجاز... للأسف ما في زر تخطي 😶",
        "نقطة جديدة، وهم جديد 😔",
        "البنك المركزي للنقاط مفلس عاطفيًا 💔",
        "تم التحويل... الله يعين الجميع 😔",
        "خذ نقطة، ما عاد تفرق كثير 😶",
        "كل الطرق تؤدي إلى نقطة إضافية 😮‍💨",
        "تمت إضافة نقطة لأن هذا ما تبقى لنا 😔",
        "إنجاز جميل... الحياة غريبة 😶",
        "نقطة مجانية مع جرعة خفيفة من فقدان الشغف 😪",
        "البوت يمر بمرحلة اكتئاب موسمية... تفضل نقطتك 🌧️",
        "تم منحك نقطة بينما أفكر باستقالتي للمرة 37 😔",
        "خذ نقطة... وادعي لنا 🥲",
    ]
